...
%     battery_history = battery_history(:,1:ceil(totalTime));
    ...
    plot(hAx,new_path_x,new_path_y,'.-','linewidth',1,'Color',clr(s,:)); % 2024 Aug. 3
...
plot(start_point(1,1),start_point(1,2),'ko','MarkerSize',10,'LineWidth',1)
...
%%
if numTarChargers == 1  % iterated 
    legend('UUV#1','UUV#2','UUV#3','shore station','UAS#1','start','visited')
else  % two charger
    legend('UUV#1','UUV#2','UUV#3','border','UAS#1','UAS#2','start','island')
end
