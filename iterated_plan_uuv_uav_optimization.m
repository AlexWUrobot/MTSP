...
btl = 7; %10; % battery life  max 12 hr battery 
...
if ~isempty(points_to_remove)   % if there is points or obstacle needs to be remove, please add the obstacle factor 99
    increaseFactor = 99;
...
if 1 % "1" for single run, "0" for multiple runs using parallel computing
    ...
    for i = 1:run_times
        ...
        a = stage1_auv_planner_uuv_uav(userConfig); % 2024 Aug 12
